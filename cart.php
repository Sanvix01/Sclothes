...
<head>
    ...
    <title>Keranjang - Sclothes</title>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="header-left">
                        <button class="mobile-menu-toggler">
                           ...
                           <a href="index.php" class="logo">
                                <span style="font-size: 50px; font-weight: bold; font-family: Arial, sans-serif;">Sclothes</span>
                            </a>
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title"><span>Keranjang Belanja</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
	                ...
	                <div class="container">
                        ...
                        ORDER BY p.id_pesanan DESC";
                                                        ...
                                                        <form action="update_cart.php" method="post">
                                                            <table class="table table-cart table-mobiile">
                                                                <thead>
                                                                    <tr>
											                            <th>Product</th>
											                            <th>Price</th>
                                         ...
                                         <figure class="product-media">
											<td class="product-col">
												<div class="product">
													<figure class="product-media">
														<a href="#">
															 <img src="admin/produk_img/<?php echo $data['gambar']; ?>" alt="<?php echo htmlspecialchars($row['gambar']); ?>" alt="produk image">
														</a>
													</figure>
                                            ...
                                            <td claass="price-col">Rp. <?php echo number_format($row['harga'],0,',',',');?><td>
        ...
        <footer class="footer">
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
                           <div class="widget widget-about">
                                <a href="index.php" class="footer-logo">Sclothes</a>
                                <p>Open sesuai mood</p>


                                <div class="social-icons">
                                    <a href="https://instagram.com/ferdinan_vix/" class="social-icon" target="_blank" title="Instagram"><i class="icon-instagram"></i></a>
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © 2025 Sclothes. All Rights Reserved.</p><!-- End .footer-copyright -->
