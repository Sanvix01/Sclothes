...
<head>
    ...
    <title>Produk - Sclothes Admin</title>
...
<body>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                           <tr>
                                               ...
                                               <td>
                                                   <a href="e_produk.php?id=<?php echo $hasil['id_produk']; ?>" class="btn tbn-warning"> 
                                                    <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <a href="h_produk.php?id=<?echo $hasil['id_produk']; ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus data?')
                                                    "> 
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Sclothes</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="https://www.instagram.com/ferdinan_vix/ target=_blank">Danta Ferdinan</a>
        </div>
    </footer><!-- End Footer -->
